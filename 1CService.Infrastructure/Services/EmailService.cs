...
namespace _1CService.Infrastructure.Services
{
    public class EmailService : IEmailService
    {
        ...
        public EmailService(IHttpContextAccessor ctx, IAppUserService appUserService, UserManager<AppUser> userManager, LinkGenerator linkGenerator)
        {
            _ctx = ctx;
        ...
        public async Task SendEmailAsync(AppUser user, string subject, string token)
        {
            ...
            emailMessage.From.Add(new MailboxAddress("Администрация сайта", "resentsmyk@mail.ru"));
